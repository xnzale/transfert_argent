...
// Returns the private 'App\Repository\SystemRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SystemRepository.php';

return $this->privates['App\\Repository\\SystemRepository'] = new \App\Repository\SystemRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
