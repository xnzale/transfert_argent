...
// Returns the private 'App\Repository\PartenairesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PartenairesRepository.php';

return $this->privates['App\\Repository\\PartenairesRepository'] = new \App\Repository\PartenairesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
